...
#define KHWWaveFillColor [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:0.48f] //填充颜色
#define KHWWaveTopColor [UIColor colorWithRed:255.0/255.0 green:0/255.0 blue:0/255.0 alpha:0.3f] //前面波浪颜色
#define KHWWaveBottomColor [UIColor colorWithRed:255.0/255.0 green:0/255.0 blue:0/255.0 alpha:0.3f] //后面波浪颜色
...
- (void)drawRect:(CGRect)rect
{
    ...
    path1.lineWidth = 1;
    //颜色
    [[UIColor colorWithRed:255.0/255 green:0/255 blue:0/255 alpha:1] set];
    //拐角
    path1.lineCapStyle = kCGLineCapRound;
    path1.lineJoinStyle = kCGLineJoinRound;
    //半径
    CGFloat radius1 = (MIN(rect.size.width, rect.size.height) - 1) * 0.5;
